...
Canonical code and rationale: `ios-kit:standards` skill, `references/ui-events.md`.
...
- Below iOS 17 (project `CLAUDE.md`): same shape with `ObservableObject` + `@Published` and `@StateObject`.
